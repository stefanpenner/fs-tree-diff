...
FSTree.prototype.mkdirpSync = function(relativePath) {
  ...
  //For path a/b/c/d, split it into a, a/b,  a/b/c, a/b/c/d and for each path check if there is an entry for that relative path
  // if there is no entry call mkdirSync to create.
